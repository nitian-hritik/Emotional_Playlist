...
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-BlNe9qkL.js';
...
const lang_map = {
  python: () => import('./index28-C-GQebsW.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-D5XkyX0-.js'),
      import('./frontmatter-EAmQEcsc.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-BbOlZ2l3.js').then((m) => m.json()),
  html: () => import('./index30-DjtnCZ4x.js').then((m) => m.html()),
  css: () => import('./index31-CvLcK-XG.js').then((m) => m.css()),
  javascript: () => import('./index32-CMare3I8.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-CMare3I8.js').then(
...
//# sourceMappingURL=Index13-BhEvEUCo.js.map
